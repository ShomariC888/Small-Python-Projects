...
class TicTacToe:
    ...
    def available_moves(self):
        return [i for i, spot in enumerate(self.board) if spot == ' ']  # if spot is a space put i into this list and then return the entire list
        
    def empty_squares(self):
        return ' ' in self.board

    def num_empty_squares(self):
        return self.board.count(' ') #count the number of spaces in the board
...
def play(game, x_player, o_player, print_game=True):
    ...
    #(we don't have to worry about winner because we'll just return that whiich breaks the loop)
